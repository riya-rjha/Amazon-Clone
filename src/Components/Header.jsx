...
const Header = () => {
    return (
        <div>
            <header className='flex items-center justify-evenly sticky top-0 bg-[#131921] p-[20px] max-h-[96px]'>
                <div className="hover:border-white hover:border cursor-pointer mr-[25px]">
                    <img src="./Images/logo.png" className='w-[115px] h-[35px] m-[5px]' />
                </div>
                <div className="flex flex-col items-center p-1 hover:border hover:border-white cursor-pointer">
                ...
                <div className='text-white p-2 cursor-pointer hover:border hover:border-white'><p>Hello, <span className='font-bold'>User</span></p>
                    <p>Accounts & Lists</p></div>
                <div className='text-white p-2 cursor-pointer hover:border hover:border-white'><p>Returns </p>
                    <p className='font-bold'>& Orders</p></div>
